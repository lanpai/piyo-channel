        ...
        <div class="box post">
          ...
          <div class="box-body">
            <form action="../post.php" method="post">
              ...
              <input type="hidden" name="board" value="<? echo $config[board]; ?>">
              <input type="hidden" name="thread" value="<? if (empty($_GET[thread])) echo 0; else echo $_GET[thread]; ?>">
